        ...
        next_finish.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (currentPage==mDots.length-1){
                    ...
                    editor.apply();
                    startActivity(new Intent(introPage.this,MainScreen.class));
                }
                else {
   ...
   @Override
    ...
    private void triggerNotification(){
        ...
        @SuppressLint("ResourceAsColor") NotificationCompat.Builder builder = new NotificationCompat.Builder(this, getString(R.string.NEWS_CHANNEL_ID))
                ...
                .setContentTitle("Wellcome To V Share App")
                .setContentText("Welcome to our Application,Register As User To Donate need people's")
                ...
                .setStyle(new NotificationCompat.BigPictureStyle().bigPicture(BitmapFactory.decodeResource(getResources(),R.drawable.vpactivity1)))
