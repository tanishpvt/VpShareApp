...
import com.example.vpshareapp.commanderacivty.ConfirmBagsSubmit;
 ...
 */
public class SchoolComfirmBags extends Fragment implements ZXingScannerView.ResultHandler {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_school_comfirm_bags, container, false);
        ...
        Dexter.withActivity(getActivity()).withPermission(Manifest.permission.CAMERA)
                .withListener(new PermissionListener() {
                    ...
                    public void onPermissionGranted(PermissionGrantedResponse response) {
                        ...
                        scannerView.setResultHandler(SchoolComfirmBags.this);
    ...
    public void handleResult(Result rawResult) {
        ...
        Intent intent=new Intent(getContext(), FinalConfirmBags.class);
