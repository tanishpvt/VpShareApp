...
public class GetLocationUser extends FragmentActivity   implements OnMapReadyCallback,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_get_location_user);
            ...
            new AlertDialog.Builder(this,4)
                    ...
                    .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialogInterface, int i) {
                            ActivityCompat.requestPermissions(GetLocationUser.this,
    ...
    public void onMarkerDragStart(Marker marker) {
        Toast.makeText(GetLocationUser.this, "onMarkerDragStart", Toast.LENGTH_SHORT).show();
    }

    @Override
    public void onMarkerDrag(Marker marker) {
        Toast.makeText(GetLocationUser.this, "onMarkerDrag", Toast.LENGTH_SHORT).show();
    }
    ...
    public boolean onMarkerClick(Marker marker) {
        Toast.makeText(GetLocationUser.this, "onMarkerClick", Toast.LENGTH_SHORT).show();
        return true;
    }
